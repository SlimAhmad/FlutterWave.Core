...
{
    /// <summary>
    /// This exception is thrown when a validation error occurs while using the PaymentPlan client.
    ...
    public class PaymentPlanClientValidationException : Xeption
    {
        public PaymentPlanClientValidationException(Xeption innerException)
            : base(message: "PaymentPlan client validation error occurred, fix errors and try again.",
                   innerException)
        { }
    }
}
